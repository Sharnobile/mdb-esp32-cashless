...
import { IconMoon, IconSun, IconBell, IconBellOff, IconDeviceMobile, IconSend, IconTrash, IconSparkles, IconEye, IconEyeOff, IconReceipt2, IconPlus, IconPencil, IconCreditCard, IconCopy } from '@tabler/icons-vue'
