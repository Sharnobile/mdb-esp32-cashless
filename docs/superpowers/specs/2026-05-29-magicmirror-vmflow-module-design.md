...
```
{
  ...
  machines: [ {
    ...
    today_revenue,
    tray_summary:     [ { product_id, product_name, image_path, severity:'critical'|'low'|'fill', deficit, sellprice, discontinued } ],
    no_stock_summary: [ { product_id, product_name, image_path, severity:'critical'|'other', deficit, sellprice, discontinued } ]
  } ],
